...
import { publishEvent } from './websocket.service.js';
...
export const notificationService = {
  ...
  // Create a notification and publish it through WebSocket
  createNotification: async (userId, type, messageValues) => {
    ...
    // Publish the notification using WebSocket
    publishEvent(channel, { notificationCreated: notification }, userId);
